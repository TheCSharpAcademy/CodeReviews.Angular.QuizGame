    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssignedGamesId = table.Column<int>(type: "int", nullable: false),
                    AssignedUsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameQuizGameUser", x => new { x.AssignedGamesId, x.AssignedUsersId });
                    table.ForeignKey(
                        name: "FK_GameQuizGameUser_AspNetUsers_AssignedUsersId",
                        column: x => x.AssignedUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameQuizGameUser_Games_AssignedGamesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameQuizGameUser_AssignedUsersId",
                table: "GameQuizGameUser",
